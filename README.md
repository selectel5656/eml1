...
Работать все на питоне, все аккаунты должны делать соединения с сервером через прокси сокс5, прокси выбирается рандомно. У прокси ставится метка что он уже взят, метки сбрасываются на все прокси когда они закончатся. чтобы брать их еще раз.
